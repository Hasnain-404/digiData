  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 rounded-2xl p-6 bg-[#0e131f] border border-slate-800/80 shadow-2xl space-y-4">
          {/* Month Header */}
            ...
            {tiles.map((day, idx) => {
              ...
              return (
                <div
                  ...
                  className={`h-20 rounded-xl p-2 border flex flex-col justify-between transition-all duration-200 ${
                    !day
                    ...
                    <>
                      ...
                      {dayData ? (
                        <div className="text-right">
                          <p className={`text-xs font-extrabold font-mono-nums ${isProfit ? 'text-emerald-400' : 'text-rose-400'}`}>
        ...
        <div className="rounded-2xl p-6 bg-[#0e131f] border border-slate-800/80 shadow-2xl flex flex-col justify-between space-y-4">
          ...
          {/* Monthly Total */}
          <div
            className={`p-4 rounded-xl border flex items-center justify-between mt-2 ${
              isMonthlyProfit
          ...
          >
            <span
              className={`text-xs font-extrabold uppercase tracking-wider ${
                isMonthlyProfit ? 'text-emerald-300' : 'text-rose-300'
              }`}
            >
              Monthly Total
            </span>
            <div className="text-right">
              <p
                className={`text-sm font-extrabold font-mono-nums ${
                  isMonthlyProfit ? 'text-emerald-400' : 'text-rose-400'
                }`}
              >
